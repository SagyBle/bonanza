...
const WideAsmachta = ({ onClose, player }) => {
  ...
  const radius = (128 + 32) / 2;
  const circumference = 2 * Math.PI * radius;

  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div
        className={`bg-gradient-to-br from-gray-900 to-black rounded-2xl shadow-2xl border-2 border-yellow-500 w-full max-w-2xl mx-auto transition-colors duration-300 ${
          player.entries > 4
            ? isRedLight
        ...
        dir="rtl"
      >
        <div className="relative p-4 border-b border-yellow-500/30">
          <h1
        ...
        <div className="p-6">
          <div
            className={`bg-gray-800/50 rounded-xl p-6 transition-shadow duration-300 ${
              player.entries > 4
                ? isRedLight
          ...
          >
            <div className="flex flex-col items-center gap-4 mb-8">
              <div className="relative p-4">
                <svg className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -rotate-90 w-[160px] h-[160px]">
                  <circle
                    cx="80"
                    cy="80"
                    r={radius}
            ...
            <div className="text-center">
              <div className="text-lg text-gray-300 mb-2">מספר כניסות</div>
              <div
          ...
          <button
            onClick={onClose}
            className={`w-full mt-6 font-bold py-3 px-6 rounded-lg transition-all text-lg ${
              player.entries > 4
                ? isRedLight
